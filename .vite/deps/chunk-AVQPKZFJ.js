...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React24.useRef(controlledProps);
  if (true) {
    React24.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React25.useState("");
  const [triggerElement, setTriggerElement] = React25.useState(null);
  const lastActionType = React25.useRef(null);
  const handleStateChange = React25.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null || onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React25.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
var Menu3 = React46.forwardRef(function Menu4(props, forwardedRef) {
...
var Modal3 = React52.forwardRef(function Modal4(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
var PopperTooltip = React60.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React60.useState(resolveAnchorEl2(anchorEl));
  React60.useEffect(() => {
...
var OutlinedInput = React92.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime72.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime71.jsxs)(React92.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AVQPKZFJ.js.map
